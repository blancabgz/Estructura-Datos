		 ...
		 */
		  ...
		  */
		  list<U>  getInfo_Asoc(const T & p);
			...
			/**
				@brief Obtiene el numero de definiciones
				@param lista
				@return devuelve el numero de definiciones que hay en la lista
			*/
			int getNumDefiniciones(list<U> l) const;

			/**
				@brief Elimina una difinicion
				@param clave: definicion que queremos borrar
			*/

			void eliminar(const T clave);

			/**
				@brief Muestra la palabra con más definiciones del diccionario
				@return Devuelve la clave que tiene más definiciones
			*/

			const T palabra_mas_definiciones();

			/**
				@brief Calcula el numero de definiciones que tiene el diccionario en total.
			...
			*/
			...
			/**
				@brief Calcula el promedio de las definiciones que tiene cada palabra
