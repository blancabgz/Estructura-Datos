 ...
 *
 * Si n=0 diremos que la cola esta vacia.
 *
...
class Cola{
  ...
  public:
     ...
     * @param original La cola de la que se hare la copia.
     */
    ...
    T& ultimo (){
      assert(ultima!=0);        //Si la cola esta vacia, abortar
      return ultima->elemento;  //Devuelve el elemento del final de la cola
    }
